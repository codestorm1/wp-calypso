...
export default function( router ) {
	...
	if ( config.isEnabled( 'google-my-business' ) ) {
		...
		router( '/google-my-business/new/:site', siteSelection, newAccount, navigation, makeLayout );
		...
		router( '/google-my-business/stats/:site', siteSelection, stats, navigation, makeLayout );
	}
}
